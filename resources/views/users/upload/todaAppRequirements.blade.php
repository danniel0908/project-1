        ...
        <div class="container">
            <div class="sidebar">
                ...
                <nav>
                    <ul>
                        <li>
                            <a href="{{ route('toda.edit',['id' => $todaApplication->id]) }}" 
                                style="color: #004d00;">1. Personal Information</a>
                        </li>
                        <li>
                            <a href="{{ route('upload.toda')}}" 
                                style="color: #004d00;">2. Requirements</a>
                        </li>
                        <li>
                            @php
                                // Count the number of approved requirements excluding Official_receipt
                                $approvedRequirementsCount = \App\Models\TodaRequirements::where('toda_application_id', $todaApplication->id)
                            ...
                            @if($hasEightApprovedRequirements)
                                <a href="{{ route('toda.payment', ['id' => $todaApplication->id]) }}" 
            ...
            <div class="main-content">
                ...
                <table>
                    ...
                    <tbody>
                    <form action="{{ route('toda.upload', ['toda_application_id' => $todaApplication->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <tr>
                            ...
                            <tr>
                                <td colspan="3" style="text-align: center">
                                    <button type="submit" class="btn btn-primary btn-sm" style="width: 200px; height:50px;">Submit</button>
                                </td>
                            </tr>
                        </form>
                    </tbody>
            ...
            <p style ="text-align: center">Note: If marked as invalid, click on the 'Invalid' mark to check the remarks.</p>

...
@section('title', 'PODA Application')
...
<div style="display: flex; justify-content: center; align-items: center; min-height: 100vh; margin-top: 20px;">
        <div class="container">
            <div class="sidebar">
                ...
                <nav>
                    <ul>
                        <li><a href="{{ route('poda.edit',['id' => $podaApplication->id]) }}" 
                        style="color: #004d00;">1. Personal Information</a></li>
                        <li><a href="{{ route('upload.poda')}}" style="color: #004d00;">2. Requirements</a></li>   
                        <li>
                            @php
                                // Count the number of approved requirements excluding Official_receipt
                                $approvedRequirementsCount = \App\Models\PodaRequirements::where('poda_application_id', $podaApplication->id)
                            ...
                            @if($hasEightApprovedRequirements)
                                <a href="{{ route('poda.payment', ['id' => $podaApplication->id]) }}" 
            ...
            <div class="main-content">
                ...
                <table>
                    ...
                    <tbody>
                        <form action="{{ route('poda.upload',['poda_application_id' => $podaApplication->id] )}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <tr>
                            ...
                            <tr>
                                <td>Pictures wearing PODA uniform (2 Original Copies)
                                <br>    
                                    @foreach($files as $file)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    editButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            fileUpdateForm.action = `/poda/update-file/${fileId}`;

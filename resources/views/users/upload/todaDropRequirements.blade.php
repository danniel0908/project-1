        ...
        <div class="container">
            <div class="sidebar">
                <label for="file-upload" class="custom-file-upload">
                    TODA Dropping Franchise
                </label>
                <input type="file" id="file-upload" style="display: none;">
                <nav>
                    <ul>
                        <li><a href="{{ route('todadrop.edit',['id' => $Application->id]) }}" style="color: #004d00;">1.) Personal Information</a></li>
                        <li><a href="{{ route('upload.todaDrop')}}" style="color: #004d00;">2.) Requirements</a></li>
                        <li>
                            @php
            ...
            <div class="main-content">
                ...
                <table>
                    ...
                    <tbody>
                        <form action="{{ route('todaDrop.upload',['toda_dropping_id' => $Application->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <tr>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            editButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    fileUpdateForm.action = `/todadrop/update-file/${fileId}`;

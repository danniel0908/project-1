...
<body>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <nav>
                <ul style="list-style: none; padding: 0;">
                    <li style="margin: 1rem 0;"><a href="{{ route('podadrop.edit', $application->id) }}" style="color: var(--primary-color); text-decoration: none; ">1. Personal Information</a></li>
                    <li style="margin: 1rem 0;"><a href="{{ route('show.upload.podadrop', $application->id)}}" style="color: var(--primary-color); text-decoration: none; " >2. Requirements</a></li>
                    <li>
                        @php
        ...
        <div class="main-content">
            ...
            <form action="{{ route('PODAdropping.update',$application->id) }}" method="POST">
            @csrf   
            @method('PUT')

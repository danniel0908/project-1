...
@endif
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <nav>
                <ul style="list-style: none; padding: 0;">
                    ...
                    <li style="margin: 1rem 0;"><a href="{{ route('schedule.create', ['serviceApplicationId' => $application->id]) }}" style="color: var(--primary-color); text-decoration: none;">2. Schedule</a></li>
                   
                    <li style="margin: 1rem 0;"><a href="{{ route('show.upload.service', $application->id) }}" style="color: var(--primary-color); text-decoration: none;">3. Requirements</a></li>
                    <li>
                        @php
        ...
        <div class="main-content">
            ...
            <form action="{{ route('ServiceApplication.update',$application->id) }}" method="POST">
                @csrf   
                @method('PUT')
                <div class="form-section">
                    ...
                    <div class="form-row">
                        ...
                        <div class="section-header">Service Name</div>
                            <input type="text" id="Service_name" name="Service_name" value="{{ $application ? $application->Service_name : '' }}" placeholder="Enter service's name">
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-column">
                            ...
                            <input type="text" id="Gender" name="Gender" value="{{ $application ? $application->Gender : '' }}" placeholder="Enter Driver's Gender">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-column">
                            ...
                            <input type="text" id="age" name="age" value="{{ $application ? $application->age : '' }}" placeholder="Enter Driver's age">
                        </div>
                    </div>
    ...
    <div class="modal-content" style="background-color: #fefefe; margin: 15% auto; padding: 20px; border: 1px solid #888; width: 80%; max-width: 500px; border-radius: 8px; position: relative;">
        ...
        <div style="text-align: center;">
            ...
            <form action="{{ route('generate.pagpapatunay.service', ['id' => $application->id]) }}" method="GET">
                @csrf

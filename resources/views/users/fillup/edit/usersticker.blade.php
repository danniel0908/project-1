...
@endif
    ...
    <div class="container">
            ...
            <nav>
                <ul style="list-style: none; padding: 0;">
                    ...
                    <li style="margin: 1rem 0;">
                        <a href="{{ route('show.upload.sticker', $application->id) }}" style="color: var(--primary-color); text-decoration: none;">
                            2. Requirements
                        </a>
                    </li>   
                    <li>
                    @php
                        $approvedRequirementsCount = \App\Models\StickerRequirements::where('sticker_application_id', $application->id)
                    ...
                    @if($hasAllRequirementsApproved)
                        <a href="{{ route('sticker.payment', ['id' => $application->id]) }}" 
        ...
        <div class="main-content">
            ...
            <form action="{{ route('PPFapplication.update',$application->id) }}" method="POST">
            @csrf   
            @method('PUT')
                <div class="form-section">
                    <div class="section-header">Association</div>
                    <div class="form-row">
                        <div class="form-column">
                        <select id="ppfAssociationSelect" name="PPF_Association" data-value="{{ $application ? $application->PPF_Association : '' }}">
                        </select>
                            </div>
                        <div class="form-column">
    ...
    <div class="modal-content" style="background-color: #fefefe; margin: 15% auto; padding: 20px; border: 1px solid #888; width: 80%; max-width: 500px; border-radius: 8px; position: relative;">
        ...
        <div style="text-align: center;">
            ...
            <form action="{{ route('generate.pagpapatunay.sticker', ['id' => $application->id]) }}" method="GET">
                @csrf
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const selectElement = document.getElementById("ppfAssociationSelect");
    if (!selectElement) {
        console.error("Association select element not found");
        return;
    }
    ...
    defaultOption.value = "";
    defaultOption.textContent = "Select Association";

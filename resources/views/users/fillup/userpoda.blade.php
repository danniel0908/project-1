...
@section('content-form')
        ...
        <div class="sidebar">
            ...
            <nav>
                <ul style="list-style: none; padding: 0;">
                    <li style="margin: 1rem 0;"><a href="{{ route('poda.fillup') }}" style="color: var(--primary-color); text-decoration: none; ">1. Personal Information</a></li>
                    <li style="margin: 1rem 0;"><a href="{{ route('upload.poda')}}" style="color: grey; pointer-events: none;">2. Requirements</a></li>
                    <li>
                        <a href="" 
                ...
                <div class="section-header">PODA Association</div>
                    ...
                    <div class="form-row">
                        <div class="form-column">
                            ...
                            <input type="text" id="bodyNo" name="Sticker_no" placeholder="Enter Sticker number">
                        </div>
                        <div class="form-column">
                            <label for="unitNo1">Unit #1</label>
                            <input type="text" id="plateNo" name="Unit_no1"  placeholder="Enter Unit number">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-column">
                            <label for="unitNo2">Unit #2</label>
                            <input type="text" id="plateNo" name="Unit_no2"  placeholder="Enter Unit number">
                        </div>
                        <div class="form-column">
                            <label for="unitNo3">Unit #3</label>
                            <input type="text" id="plateNo" name="Unit_no3"  placeholder="Enter Unit number">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-column">
                            <label for="unitNo4">Unit #4</label>
                            <input type="text" id="plateNo" name="Unit_no4"  placeholder="Enter Unit number">
                        </div>
                        <div class="form-column">
    ...
    <script src="{{ asset('form/form_podaModal.js') }}"></script>

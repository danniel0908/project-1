...
@section('content-form')
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <nav>
                <ul style="list-style: none; padding: 0;">
                    <li style="margin: 1rem 0;"><a href="{{ route('poda.drop.fillup') }}" style="color: var(--primary-color); text-decoration: none; ">1. Personal Information</a></li>
                    <li style="margin: 1rem 0;"><a href="{{ route('upload.podaDrop')}}" style="color: grey; pointer-events: none;">2. Requirements</a></li>
                    <li>
                        <a href="" 
        ...
        <div class="main-content">
            ...
            <form action="{{ route('PODAdropping.store') }}" method="POST">
            @csrf   

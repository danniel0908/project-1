...
<body>
    ...
    <div class="section">
        ...
        <div class="field">
            <span class="field-label">PODA Association:</span>
            {{ $application->PODA_Association }}
        </div>
        <div class="field">
            <span class="field-label">Sticker Number:</span>
            {{ $application->Sticker_no }}
        </div>
        <div class="field">
            <span class="field-label">Unit/s:</span>
            {{ $application->Unit_no1 }}
        </div>
        <div class="field">
            {{ $application->Unit_no2 }}
        </div>
        <div class="field">
            {{ $application->Unit_no3 }}
        </div>
        <div class="field">
            {{ $application->Unit_no4 }}
        </div>
    </div>

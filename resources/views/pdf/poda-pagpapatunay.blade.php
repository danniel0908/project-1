...
<body>
    ...
    <div class="content">
        <p>Ito ay nagpapatunay na si {{ $applicant_name }} ay isang lehitimong miyembro ng {{ $poda_association }} na may ID Number {{ $custom_id }}.</p>
        ...
        <table class="info-table">
            ...
            <tr>
                <td><strong>PODA Association:</strong></td>
                <td>{{ $poda_association }}</td>
            </tr>
            <tr>

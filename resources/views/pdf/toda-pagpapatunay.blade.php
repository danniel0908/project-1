...
<body>
    ...
    <div class="content">
        <p>Ito ay nagpapatunay na si {{ $applicant_name }} ay isang lehitimong miyembro ng {{ $toda_association }} na may ID Number {{ $custom_id }}.</p>
        ...
        <table class="info-table">
            ...
            <tr>
                <td><strong>TODA Association:</strong></td>
                <td>{{ $toda_association }}</td>
            </tr>
            <tr>

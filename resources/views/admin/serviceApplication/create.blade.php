...
@section('title')
New Private Service Application
@endsection
                ...
                <div class="d-flex justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active">Create Private Service Application</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
<script>
    ...
    // Loop through the options array and add options to the select element
    ...
    // Add another schedule group
    document.getElementById('add-schedule').addEventListener('click', function() {
        var scheduleContainer = document.getElementById('schedule-container');
        var scheduleGroup = document.querySelector('.schedule-group').cloneNode(true);

        // Clear input values
        var inputs = scheduleGroup.querySelectorAll('input');

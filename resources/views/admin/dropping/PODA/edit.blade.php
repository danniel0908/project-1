    ...
    <div class="container-fluid py-4">
        <div class="card shadow-sm">
                ...
                <div class="d-flex justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="{{ route('PODAdropping.index') }}" class="text-decoration-none">Back to List</a></li>
                            <li class="breadcrumb-item active">PODA Dropping Application</li>
                        </ol>
                    </nav>
                </div>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('PODAdropping.update',$PODAdropping->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="applicant_first_name" id="applicant_first_name"
                                           class="form-control" 
                                           value="{{ $PODAdropping->applicant_first_name  }}" 
                                           required>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="applicant_middle_name" id="applicant_middle_name"
                                           class="form-control" 
                                           value="{{ $PODAdropping->applicant_middle_name  }}" 
                                           >
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="applicant_last_name" id="applicant_last_name"
                                           class="form-control" 
                                           value="{{ $PODAdropping->applicant_last_name  }}" 
                                            required>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="applicant_suffix" id="applicant_suffix"
                                           class="form-control" 
                                           value="{{ $PODAdropping->applicant_suffix  }}" 
                                           >
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="Validity_Period" 
                                           class="form-control" 
                                           value="{{ $PODAdropping->validity_period  }}" 
                                            required>
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="reasons" 
                                ...
                                class="form-control" 
                                rows="4"
                                placeholder="Enter reason here">{{ $PODAdropping->reasons  }}</textarea>
                    </div>
                    <!-- Submit Button -->
                    <div class="text-end">
